...
5. [requirements.txt](https://github.com/andreapondini/DFT_He/blob/M/requirements.txt) : Containes the dependencies needed in order for the script to run. The file was obtained using [pipreqs](https://pypi.org/project/pipreqs/). The oldest version of python able to run the script is python 3.7.
